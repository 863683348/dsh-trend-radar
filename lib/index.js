    ...
    output: {
      schema: {
        ...
        properties: {
          ...
          newPlugins: { type: "array", required: true, items: { type: "object", additionalProperties: false, properties: { name: { type: "string", required: true }, stars: { type: "integer", required: true }, created: { oneOf: [{ type: "integer" }, { type: "null" }], required: true }, desc: { type: "string", required: true }, category: { type: "string", required: true } } } },
          starGainers: { type: "array", required: true, items: { type: "object", additionalProperties: false, properties: { name: { type: "string", required: true }, delta: { type: "integer", required: true }, stars: { type: "integer", required: true } } } },
          categoryHeat: { type: "array", required: true, items: { type: "object", additionalProperties: false, properties: { category: { type: "string", required: true }, count: { type: "integer", required: true } } } },
          text: { type: "string", required: true },
        },
      },
      render: (_args, value) => [{ type: "text", text: value.text }],
    ...
    output: {
      schema: {
        ...
        properties: {
          ...
          matches: { type: "array", required: true, items: { type: "object", additionalProperties: false, properties: { name: { type: "string", required: true }, keyword: { type: "string", required: true }, stars: { type: "integer", required: true }, created: { oneOf: [{ type: "integer" }, { type: "null" }], required: true }, desc: { type: "string", required: true } } } },
          text: { type: "string", required: true },
        },
      },
      render: (_args, value) => [{ type: "text", text: value.text }],
